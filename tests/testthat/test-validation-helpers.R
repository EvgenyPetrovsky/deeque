# udf_gt
test_that("'Greater than' function generates another function", {
  expect_equal(typeof(udf_gt(3)), "closure")
})

test_that("'Greater than' function generates another function that takes one parameter", {
  x <- 3
  f <- udf_gt(x)
  expect_equal(length(formals(f)), 1)
})

test_that("'Greater than' function generates another function that returns boolean result", {
  x <- 3
  f <- udf_gt(x)
  expect_equal(typeof(f(x)), "logical")
})

test_that("'Greater than' function generates another function that works as expected", {
  x <- 3
  f <- udf_gt(x)
...
# udf_ge
test_that("'Greater than or Equal to' function generates another function", {
  expect_equal(typeof(udf_ge(3)), "closure")
})

test_that("'Greater than or Equal to' function generates another function that takes one parameter", {
  x <- 3
  f <- udf_ge(x)
  expect_equal(length(formals(f)), 1)
})

test_that("'Greater than or Equal to' function generates another function that returns boolean result", {
  x <- 3
  f <- udf_ge(x)
  expect_equal(typeof(f(x)), "logical")
})

test_that("'Greater than or Equal to' function generates another function that works as expected", {
  x <- 3
  f <- udf_ge(x)
  expect_equal(f(x - 1), FALSE)
...
# udf_lt
test_that("'Less than' function generates another function", {
  expect_equal(typeof(udf_lt(3)), "closure")
})

test_that("'Less than' function generates another function that takes one parameter", {
  x <- 3
  f <- udf_lt(x)
  expect_equal(length(formals(f)), 1)
})

test_that("'Less than' function generates another function that returns boolean result", {
  x <- 3
  f <- udf_lt(x)
  expect_equal(typeof(f(x)), "logical")
})

test_that("'Less than' function generates another function that works as expected", {
  x <- 3
  f <- udf_lt(x)
  expect_equal(f(x - 1), TRUE)
  expect_equal(f(x), FALSE)
...
# udf_le
test_that("'Less than or Equal to' function generates another function", {
  expect_equal(typeof(udf_le(3)), "closure")
})

test_that("'Less than or Equal to' function generates another function that takes one parameter", {
  x <- 3
  f <- udf_le(x)
  expect_equal(length(formals(f)), 1)
})

test_that("'Less than or Equal to' function generates another function that returns boolean result", {
  x <- 3
  f <- udf_le(x)
  expect_equal(typeof(f(x)), "logical")
})

test_that("'Less than or Equal to' function generates another function that works as expected", {
  x <- 3
  f <- udf_le(x)
  expect_equal(f(x - 1), TRUE)
  expect_equal(f(x), TRUE)
...
# udf_between
test_that("'Between' function generates another function", {
  x1 <- 3
  x2 <- 6
  expect_equal(typeof(udf_between(x1, x2, "b")), "closure")
})

test_that("'Between' function generates another function that takes one parameter", {
  x1 <- 3
  x2 <- 6
...
test_that("'Between' function generates another function that returns boolean result", {
  x1 <- 3
  x2 <- 6
  f1 <- udf_between(x1, x2)
  f2 <- udf_between(x1, x2, "b")
...
test_that("'Between' function generates another function that works as expected", {
  x1 <- 3
  x2 <- 6
